...
public class BrowserUtilities {
    ...
    public static void switchwimdow(String title){
        Set<String> windowHanles= com.vytrack.utilities.Driver.getDriver().getWindowHandles();
        for(String window : windowHanles){
